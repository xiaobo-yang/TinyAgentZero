...
EXP_NAME=$ENV-$MODEL_NAME-PPO-${RUN_TIME}
git add .
...
python -m src.core.main_ppo \
    +env.name=$ENV \
    data.train_files=$DATA_PATH/deepcoder_train_sample_1000.parquet \
    data.val_files=$DATA_PATH/test_livecodebench_sample_10.parquet \
    ...
    actor_rollout_ref.rollout.temperature=0.45 \
